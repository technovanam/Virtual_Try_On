    ...
    <View className="py-4 w-full">
      ...
      >
        <View className="bg-white/10 self-start px-3 py-[6px] rounded-[20px] mb-4 border border-white/20">
          <Text className="text-[#C084FC] text-xs font-extrabold tracking-[1.5px]">HAIRVERSE AI</Text>
        </View>

        <Text className="text-[28px] font-black text-white mb-3 leading-[34px]">Find Your Perfect Hairstyle</Text>
        <Text className="text-[15px] text-white/85 mb-7 leading-[22px]">
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Text className="text-[#C084FC] text-sm font-semibold tracking-[0.5px]">Try Trending Styles →</Text>
        </TouchableOpacity>
      </LinearGradient>
    </View>
  );
