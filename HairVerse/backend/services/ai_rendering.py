...
def render_tryon_composition(image_bytes: bytes, hairstyle_id: str, hair_color: str, beard_style: str) -> str:
    ...
    try:
        ...
        if beard_style and "clean" not in beard_style.lower():
            ...
            # Draw a chin arc to simulate beard overlay
            cv2.ellipse(canvas, (center_x, center_y + face_radius // 2), (face_radius - 10, face_radius // 2), 0, 0, 180, beard_color, 8 if "stubble" in beard_style.lower() else 20)
